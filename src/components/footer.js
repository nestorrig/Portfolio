export class Footer extends HTMLElement {
    constructor() {
        super();
        this.visibleTop = this.getAttribute('visibleTop') || 'default-value';
    }
    ...
    getTemplate() {
        ...
        template.innerHTML = `
            <footer class="footer z__1" id="Contact">
                <div class="footer__1 bg__1 ${this.visibleTop}">
                </div>
                <div class="footer__2 bg__3">
                    <div class="footer__list center">
                        <figure class="footer__list__logo svg__logo">
                            <img src="./src/assets/logos/logo_name.svg" alt="Logo">
                        </figure>
                        <nav class="footer__list__social">
                            <div>
                                <a target="_blank" rel="noopener noreferrer" href="https://github.com/nestorrig">
                            ...
                            <div>
                                <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/nestorrig">
                                    <svg xmlns="http://www.w3.org/2000/svg"  width="40" height="40" viewBox="0 0 24 24">
                            ...
                            <div>
                                <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/nestorrig">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
                            ...
                            <div>
                                <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/nestorrig">
                                    <svg xmlns="http://www.w3.org/2000/svg"  width="40" height="40" viewBox="0 0 24 24">
                            ...
                            <div>
                                <a target="_blank" rel="noopener noreferrer" href="https://platzi.com/p/nestorrig/">
                                    <svg xmlns="http://www.w3.org/2000/svg"  width="40" height="40" viewBox="0 0 24 24">
